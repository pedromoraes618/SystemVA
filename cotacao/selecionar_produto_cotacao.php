...
<?php
    ...
    $inserir .= "(cotacaoID, descricao , quantidade, preco_compra, margem , preco_venda )";
    $inserir .= " VALUES ";
    $inserir .= "('$codCotacao','$nomeProduto','$qtdProduto','$precoCompra', '$margem' ,'$precoVenda')";
        ...
        <div style="margin:0 auto; width:1500px; ">
            ...
            <table style="float:left; width:900px; margin-top:5px;">
                ...
                <tr>
                    ...
                    <td align=left><input readonly type="text" size="10" name="codigoCotacao"
            ...
            <table style="float:left; ">
                <tr>
                    <td><b>Produto:</b></td>
                    <td align=left><input style="margin-left:25px;" type="text" size=60 name="campoNomeProduto" value="<?php if(isset($_POST['adicionar'])){ echo utf8_encode($nomeProduto);} elseif(!isset($_POST['adicionar'])){
                                    echo $descrisaoGet;
                                }?>">
                    </td>
                </tr>
