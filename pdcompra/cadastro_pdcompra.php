                ...
                <div style="width: 1500px;">
                    ...
                    <table style="float:left;">
                        ...
                        <tr>
                            ...
                            <td align=left> <input type="text" size=20 id="campoOrcamento" name="campoOrcamento" autocomplete="off"
                        ...
                        <table style="float: left;">
                            <tr>
                                ...
                                <td align=left style="width: 180px;"><b>Status do pedido*:</b></td>
                                <td align=left><select id="campoStatusPedido" name="campoStatusPedido">
                                        <?php 
