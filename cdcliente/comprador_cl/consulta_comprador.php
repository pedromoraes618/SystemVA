...
<body>
    ...
    <main>
        ...
        <div style="margin-top:0px" id="janela_pesquisa">
            ...
            <div id="BotaoLancar">
            <input  type="submit" class="btnvoltar" id="btnvoltar" onclick="fechar();" name="voltar" value="Voltar"></input>
           ...
           ?>
                    ...
                    <tr id="linha_pesquisa">
                        ...
                        <td id="botaoEditar">
                            ...
                            <a href="editar_comprador.php?comprador=<?php echo $linha["id_comprador"]?>">
