...
if (isset($_POST['enviar'])){
    $nComprador = $_POST['momeComprador'];
  ...
  //inserindo as informações no banco de dados
    ...
    $inserir .= "(id_cliente,comprador,observacao,email,contato) ";
    $inserir .= " VALUES ";
    $inserir .= "( '$clienteID','$nComprador','$obs',' $email','$contato' )";
        ...
        <form action="cadastro_comprador.php?cliente=<?php echo $_GET['cliente'];?>" method="post">
            ...
            <table width=100%>
                ...
                <tr>
                    ...
                    <td align=left><input type="text"  required="Favor preencher o campo" size=53 name="momeComprador" id="momeComprador" value="<?php if(isset($_POST['enviar'])){
                                echo $nComprador;
                            }?>">
                </tr>
                ...
                <tr>
                    ...
                    <td align=left><input type="text" size=53 name="contato" id="contato" value="<?php if(isset($_POST['enviar'])){
                                echo $contato;
                            }?>">
                </tr>
