...
<div class="row">
	<div class="col-sm-4">
		<form id="frmVendasProdutos">
			...
			<textarea  id="descricaoV" name="descricaoV" class="form-control input-sm"></textarea>
			<label>Quantidade Estoque</label>
			<input  type="text" class="form-control input-sm" id="quantidadeV" name="quantidadeV">
			<label>Preço</label>
			<input  type="text" class="form-control input-sm" id="precoV" name="precoV">
			...
			<a href="../../inicial.php">
			<button style="width: 150px;" type="button" id="btnVoltar" class="btn btn-secondary">voltar</button>
			</a>
		</form>
	</div>
