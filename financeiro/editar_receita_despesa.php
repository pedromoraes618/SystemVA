...
//alterando as informações no banco de dados
    ...
    $alterar = "UPDATE lancamento_financeiro set nomeproduto = '{$nome_produdo}', precovenda = '{$preco_venda}', precocompra = '{$preco_compra}',  estoque = '{$estoque}', ";
...
<body>
    <main>
        <form action="editar_receita_despesa.php" method="post">
            <div id="titulo">
