...
$select = " SELECT usuarios.usuarioID, usuarios.email, usuarios.nome, tb_nivel_usuario.descricao AS nivelUsuario, usuarios.usuario, usuarios.nivel from tb_nivel_usuario inner join usuarios on usuarios.usuarioID = tb_nivel_usuario.nivel_usuarioID";
